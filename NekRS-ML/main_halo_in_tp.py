...
def train(cfg: DictConfig) -> None:
    ...
    n_nodes_halo = trainer.data_reduced.n_nodes_halo.item()
    ...
    for epoch in range(trainer.epoch_start, cfg.epochs+1):
        ...
        if epoch>trainer.epoch_start+1:
            ...
            epoch_throughput.append((n_nodes_halo+n_nodes_local)/epoch_time)
            batch_times.extend(train_metrics['batch_times'])
            batch_throughput.extend([(n_nodes_halo+n_nodes_local)/time for time in train_metrics['batch_times']])
