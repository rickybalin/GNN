...
EXE=/lustre/orion/csc613/proj-shared/balin/Nek/GNN/GNN/NekRS-ML/all2all.py
ARGS="--all_to_all_buff=optimized --iterations=50 --master_addr=${MASTER_ADDR} --master_port=3442"
