...
EXE=/eagle/datascience/balin/Nek/GNN/GNN/NekRS-ML/main_orig.py
...
echo
echo `date`
mpiexec --envall -n $PROCS --ppn $PROCS_PER_NODE --cpu-bind=list:24:16:8:1 ./affinity_polaris.sh python $EXE ${ARGS} 
echo `date`
