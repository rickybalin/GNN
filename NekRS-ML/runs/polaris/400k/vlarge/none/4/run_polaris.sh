...
DATA_PATH=/eagle/datascience/balin/Nek/GNN/weak_scale_data/400k_polaris/${PROCS}/gnn_outputs_poly_5/

#EXE=/eagle/datascience/balin/Nek/GNN/GNN/NekRS-ML/main.py
EXE=/eagle/datascience/balin/Nek/GNN/GNN/NekRS-ML/main_no_edge_attr.py
ARGS="n_messagePassing_layers=6 backend=nccl halo_swap_mode=${HALO_SWAP_MODE} gnn_outputs_path=${DATA_PATH}"
